...
import 'package:graduation_project/features/home_feature/data/home_data/navigation_bar_screens.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<HomeNavigationBarCubit, HomeNavigationBarStates>(
      builder: (context, state) => Scaffold(
        ...
        body: SafeArea(
          child: NavigationBarScreens.screens[indexFromExternal ??
